    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-50 font-sans selection:bg-zinc-800 relative pb-10">
      ...
      <div className="mx-auto max-w-7xl p-4 md:p-6 lg:p-8">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
          <div className="overflow-hidden rounded-[2.25rem] border border-zinc-800/70 bg-zinc-950/70 shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-sm">
            <div className="relative h-[260px] md:h-[340px]">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 md:p-8 text-right" dir="rtl">
                ...
                <div className="mt-4 max-w-2xl">
                  <h1 className="text-3xl md:text-5xl font-bold tracking-normal text-white">
                    מסך בית חד, נקי וחזק לאימונים שלך
                  </h1>
                  <p className="mt-3 text-sm md:text-base text-zinc-300">
                    תוכנית שבועית, כניסה מהירה לכל יום, מעבר ללייב, גישה לכל השרירים, וקישור מהיר למוזיקה לאימון.
                  </p>
                </div>
...
<div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr]">
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="rounded-[2rem] border border-emerald-500/25 bg-[linear-gradient(135deg,rgba(16,185,129,0.16),rgba(16,185,129,0.04))] p-5 md:p-6 shadow-[0_14px_50px_rgba(0,0,0,0.3)] transition hover:-translate-y-1"
  >
                        ...
                        <div className="grid sm:grid-cols-[180px_1fr]">
                          ...
                          <div className="p-5 flex flex-col justify-between">
                            ...
                            <div className="flex flex-wrap gap-3 items-center">
                              ...
                              <Button variant="ghost" size="icon" className="text-indigo-400" onClick={() => setAiExerciseToAsk(ex)}>
