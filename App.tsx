...
const MASTER_VAULT: Exercise[] = [
  ...
  { id: "b5", name: "Rack Pulls", sets: 4, reps: "5-8", he: "משיכת מוט מהכלוב החל מגובה הברך. בונה גב תחתון וזוקפים חזקים כמו בטון. תרגיל ליבה לבניית כוח אבסולוטי.", work: 30, rest: 150, category: "pull", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=fGZpM_1mZpM", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Elite" },
  { id: "b6", name: "Seal Row", sets: 3, reps: "10-12", he: "שכיבה על ספסל מוגבה ומשיכת מוט מלמטה. מנטרל לחלוטין את הרגליים והמומנטום. הדרך הטובה ביותר לבודד את הגב ללא לחץ על עמוד השדרה.", work: 40, rest: 90, category: "pull", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=vV7B52Z6m40", imageUrl: "https://images.unsplash.com/photo-1603287611837-f2146f5de8e8?q=80&w=800", difficulty: "Advanced" },
  { id: "b7", name: "Lat Prayer", sets: 3, reps: "15", he: "משיכה עם ידיים ישרות בפולי עליון. תרגיל בידוד מושלם ללטים שמלמד איך להשתמש בגב ללא מעורבות של הבייספס.", work: 35, rest: 60, category: "isolation", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=G6f6z08hKao", imageUrl: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=800", difficulty: "Standard" },
  { id: "b8", name: "Pendlay Row", sets: 4, reps: "8", he: "חתירה מתפרצת מהרצפה כאשר הגב מקביל לחלוטין לקרקע. המוט חוזר לרצפה בכל חזרה. בונה כוח מתפרץ ושליטה בשכמות.", work: 45, rest: 120, category: "pull", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=hED0mP9v7Lw", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Elite" },
  { id: "b9", name: "Kroc Rows", sets: 3, reps: "20+", he: "חתירה עם משקולת כבדה מאוד בסטים של חזרות גבוהות. שימוש במומנטום מבוקר. התרגיל בונה אחיזה חזקה וגב עליון רחב ועוצמתי.", work: 60, rest: 120, category: "pull", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=D7MInZ9D6mU", imageUrl: "https://images.unsplash.com/photo-1603287611837-f2146f5de8e8?q=80&w=800", difficulty: "Elite" },
  { id: "b10", name: "Snatch Grip High Pull", sets: 4, reps: "6", he: "משיכה מהירה של המוט עד גובה החזה באחיזה רחבה מאוד. תרגיל כוח מתפרץ שעובד על הטרפזים והכתפיים האחוריות בעוצמה גבוהה.", work: 30, rest: 150, category: "power", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=pE7Uu_P0S8Y", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Elite" },
  { id: "b11", name: "Incline DB Row", sets: 3, reps: "12", he: "שכיבה על ספסל בשיפוע עם הפנים למטה. משיכת משקולות תוך כדי הצמדת השכמות. מבודד את הגב העליון ומנטרל לחלוטין את הגב התחתון.", work: 40, rest: 90, category: "pull", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=8I0GvWvY2q8", imageUrl: "https://images.unsplash.com/photo-1603287611837-f2146f5de8e8?q=80&w=800", difficulty: "Advanced" },
  { id: "b12", name: "Barbell Pullover", sets: 3, reps: "12", he: "מתיחת המוט מעבר לראש בשכיבה על ספסל. עובד על הלטים ומרחיב את כלוב הצלעות. דגש על נשימה עמוקה בשלב המתיחה.", work: 40, rest: 75, category: "pull", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=j9_M-pDshg4", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Standard" },
  { id: "b13", name: "Chin-Ups", sets: 3, reps: "10", he: "עליות מתח באחיזה הפוכה וצרה. מדגיש את הבייספס ואת הלטים התחתונים. הקפד על טווח תנועה מלא ומתיחה בתחתית.", work: 40, rest: 90, category: "pull", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=mRy9msh96V8", imageUrl: "https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?q=80&w=800", difficulty: "Standard" },
  { id: "b14", name: "Renegade Row", sets: 3, reps: "10/side", he: "מצב פלאנק על משקולות וחתירה לסירוגין. תרגיל מטורף לליבה ולגב. שמור על אגן יציב ללא סיבוב הגוף.", work: 50, rest: 90, category: "power", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=Wp49v7p_G0U", imageUrl: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=800", difficulty: "Advanced" },
  { id: "b15", name: "Deadlift (Conventional)", sets: 3, reps: "5", he: "הרמת המוט מהרצפה תוך שימוש בכל הגוף. בונה כוח בסיסי, זוקפי גב ורגליים עוצמתיות. התרגיל הכי חשוב לבניית כוח אבסולוטי.", work: 45, rest: 180, category: "power", muscleGroup: "Back", videoUrl: "https://www.youtube.com/watch?v=r4MzxtBKyNE", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Elite" },
  ...
  { id: "c3", name: "Converging Press", sets: 3, reps: "10-12", he: "לחיצה במכונה שבה הידיות מתקרבות אחת לשנייה בשיא התנועה. מאפשר סחיטה מקסימלית של סיבי החזה הפנימיים.", work: 40, rest: 90, category: "push", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=9_I7v0p2uFk", imageUrl: "https://images.unsplash.com/photo-1591741535018-d042766c62eb?q=80&w=800", difficulty: "Standard" },
  { id: "c4", name: "Floor Press", sets: 3, reps: "8", he: "לחיצה בשכיבה על הרצפה. עוצר את התנועה ב-90 מעלות במרפקים. מצוין לשיפור כוח הנעילה ומניעת פציעות כתף.", work: 40, rest: 90, category: "push", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=uUGDRwge4F8", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Advanced" },
  { id: "c5", name: "Cable Flyes", sets: 3, reps: "15", he: "משיכת כבלים מלמעלה למטה. מתמקד בחלק התחתון והחיצוני של החזה. שמור על חזה נפוח וכתפיים משוכות לאחור.", work: 35, rest: 60, category: "isolation", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=W0v-A-SOnsc", imageUrl: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=800", difficulty: "Standard" },
  { id: "c6", name: "Hex Press", sets: 3, reps: "12", he: "הצמד את המשקולות אחת לשנייה לאורך כל הלחיצה. יוצר מתח תמידי בחלק המרכזי של החזה.", work: 35, rest: 75, category: "isolation", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=OonLz_u_kAg", imageUrl: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=800", difficulty: "Standard" },
  { id: "c7", name: "Flat Bench Press", sets: 4, reps: "6-8", he: "לחיצת חזה קלאסית עם מוט. התרגיל הבסיסי ביותר לבניית מסה וכוח בחזה האמצעי והכללי.", work: 45, rest: 120, category: "push", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=vcBig73ojpE", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Advanced" },
  { id: "c8", name: "Guillotine Press", sets: 3, reps: "10", he: "לחיצת חזה שבה המוט יורד לכיוון הצוואר. תרגיל מתקדם שמבודד את סיבי החזה העליונים בצורה קיצונית. דורש שליטה.", work: 45, rest: 100, category: "push", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=x7E-0O9vU5o", imageUrl: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=800", difficulty: "Elite" },
  { id: "c9", name: "Low-To-High Cable Fly", sets: 3, reps: "15", he: "משיכת כבלים מלמטה למעלה לכיוון הפנים. התרגיל הטוב ביותר לעיצוב ובידוד החזה העליון.", work: 35, rest: 60, category: "isolation", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=Cq_unC59YmU", imageUrl: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=800", difficulty: "Standard" },
  { id: "c10", name: "Landmine Chest Press", sets: 3, reps: "10-12", he: "דחיפת המוט באלכסון מלמטה למעלה. בונה כוח מתפרץ בחזה העליון ומגן על מפרק הכתף. מעולה לסיום אימון.", work: 40, rest: 90, category: "push", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=v_mC9N0C-kU", imageUrl: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=800", difficulty: "Advanced" },
  { id: "c11", name: "Pec Deck Fly", sets: 3, reps: "15", he: "בידוד חזה במכונה. הקפד על סחיטה מקסימלית של הידיות במרכז ושחרור איטי למתיחה עמוקה של הסיבים.", work: 30, rest: 60, category: "isolation", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=O-L9_S2E5pM", imageUrl: "https://images.unsplash.com/photo-1591741535018-d042766c62eb?q=80&w=800", difficulty: "Standard" },
  { id: "c12", name: "Push-Ups (Weighted)", sets: 3, reps: "Max", he: "שכיבות סמיכה קלאסיות עם פלטה על הגב. בונה סיבולת שריר וכוח בסיסי בחזה ובליבה בצורה פונקציונלית.", work: 45, rest: 75, category: "push", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=S-H7NIn7TmA", imageUrl: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=800", difficulty: "Standard" },
  { id: "c13", name: "Incline Barbell Press", sets: 4, reps: "6-8", he: "לחיצת מוט בשיפוע חיובי. בונה את מסת החזה העליון בצורה הבסיסית והאפקטיבית ביותר.", work: 45, rest: 120, category: "push", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=SrqOu55lr6A", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Advanced" },
  { id: "c14", name: "Svend Press", sets: 3, reps: "20", he: "הצמד את שתי פלטות משקולת בין הידיים ודחיפה קדימה תוך כיווץ חזק. תרגיל סיום מעולה להזרמת דם ופאמפ.", work: 30, rest: 45, category: "isolation", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=N_vFvS_Q_w8", imageUrl: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=800", difficulty: "Standard" },
  { id: "c15", name: "Spoto Press", sets: 4, reps: "5", he: "לחיצת חזה עם עצירה של שנייה סנטימטר מעל החזה. בונה כוח מתפרץ ויציבות אדירה בלחיצה תחת עומס.", work: 40, rest: 150, category: "push", muscleGroup: "Chest", videoUrl: "https://www.youtube.com/watch?v=ZcM93Z6D2wE", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Elite" },
  ...
  { id: "l4", name: "Nordic Curl", sets: 3, reps: "5-8", he: "בלום את עצמך בירידה איטית לכיוון הרצפה רק בעזרת הרגליים. המלך של תרגילי ההמסטרינג למניעת פציעות.", work: 30, rest: 120, category: "legs", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=H7mfa68vI_M", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Elite" },
  { id: "l5", name: "Kas Glute Bridge", sets: 3, reps: "12-15", he: "טווח תנועה קטן וממוקד לישבן על ספסל. סחיטה חזקה בשיא התנועה. בונה ישבן חזק ומעוצב.", work: 40, rest: 90, category: "legs", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=mD0iXoflI0E", imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800", difficulty: "Standard" },
  { id: "l6", name: "Hack Squat", sets: 4, reps: "8-10", he: "סקוואט במכונה ייעודית המאפשרת ירידה עמוקה מאוד עם תמיכה מלאה לגב. מיקוד מוחלט בקוואדס.", work: 45, rest: 120, category: "legs", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=Ed7mreY12Sg", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Advanced" },
  { id: "l7", name: "Leg Press (High Foot)", sets: 4, reps: "12-15", he: "הנח את הרגליים בחלק העליון של הפלטה. דחיפה מהעקבים. מעביר את הדגש מהקוואדס לישבן ולהמסטרינג.", work: 45, rest: 90, category: "legs", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=IZxyjW7MPJQ", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Standard" },
  { id: "l8", name: "Walking Lunges", sets: 3, reps: "20 Steps", he: "צעדי מכרע קדימה עם משקולות. בונה כוח דינמי וסיבולת שריר בירכיים ובישבן. שמור על גב זקוף.", work: 60, rest: 90, category: "legs", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=DlhojghkaQ0", imageUrl: "https://images.unsplash.com/photo-1574680096145-d05b474e2155?q=80&w=800", difficulty: "Standard" },
  { id: "l9", name: "Goblet Squat (Cyclist)", sets: 3, reps: "15", he: "סקוואט עם עקבים מוגבהים ומשקולת מול החזה. ירידה עמוקה מאוד למיקוד אגרסיבי בשריר הקוואדס.", work: 40, rest: 75, category: "legs", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=L99i8n5N6gU", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Advanced" },
  { id: "l10", name: "Stiff-Legged Deadlift", sets: 4, reps: "8-10", he: "מוט יורד לאט קרוב לרגליים עם ברכיים כמעט ישרות. דגש על מתיחה מקסימלית של ההמסטרינג והזוקפים.", work: 45, rest: 120, category: "pull", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=f-BstW84vXY", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Elite" },
  { id: "l11", name: "Standing Calf Raises", sets: 4, reps: "20", he: "הרמת עקבים בעמידה עם משקל כבד. סחיטה בשיא הכיווץ ומתיחה מלאה בתחתית. בונה שוקיים חזקים.", work: 30, rest: 60, category: "isolation", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=YM07NHeI9sM", imageUrl: "https://images.unsplash.com/photo-1434682881908-b43d0467b798?q=80&w=800", difficulty: "Standard" },
  { id: "l12", name: "Seated Leg Extension", sets: 3, reps: "20", he: "פשיטת רגליים במכונה. בידוד מושלם לקוואדס. סחוט את השריר בשיא התנועה ורד לאט ובשליטה.", work: 30, rest: 60, category: "isolation", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=m0FOpMEgero", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Standard" },
  { id: "l13", name: "Box Squat", sets: 4, reps: "6", he: "סקוואט עד לישיבה על קופסה ועצירה. בונה כוח מתפרץ אדיר מהמקום הנמוך ביותר ללא מומנטום.", work: 45, rest: 150, category: "legs", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=9_ZAs-QW4pY", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Advanced" },
  { id: "l14", name: "Adductor Machine", sets: 3, reps: "15", he: "קירוב ירכיים במכונה. מחזק את השרירים המקרבים בירך הפנימית ומונע פציעות במפרק הירך.", work: 30, rest: 60, category: "isolation", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=9tqR6MvXyos", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Standard" },
  { id: "l15", name: "Step-Ups (High Box)", sets: 3, reps: "12/leg", he: "עלייה על קופסה גבוהה עם משקולות. בונה כוח חד צדדי ויציבות ליבה מטורפת. דגש על דחיפת העקב.", work: 45, rest: 75, category: "legs", muscleGroup: "Legs", videoUrl: "https://www.youtube.com/watch?v=dQqApCGd5Ss", imageUrl: "https://images.unsplash.com/photo-1574680096145-d05b474e2155?q=80&w=800", difficulty: "Standard" },

  // --- GLUTES (4) ---
  { id: "g1", name: "Barbell Hip Thrust", sets: 4, reps: "8-12", he: "השען על ספסל, הנח מוט על האגן ודחוף את האגן למעלה עד כיווץ מלא. תרגיל בסיס חזק מאוד לישבן.", work: 45, rest: 90, category: "legs", muscleGroup: "Glutes", videoUrl: "https://www.youtube.com/watch?v=h6m7Ush8uAs", imageUrl: "https://images.unsplash.com/photo-1574680096145-d05b474e2155?q=80&w=800", difficulty: "Advanced" },
  { id: "g2", name: "Cable Glute Kickback", sets: 3, reps: "15/leg", he: "פשיטת ירך לאחור בכבל עם שליטה מלאה וסחיטה בשיא. בידוד מצוין לישבן.", work: 35, rest: 60, category: "isolation", muscleGroup: "Glutes", videoUrl: "https://www.youtube.com/watch?v=IrJ8jL8fXm0", imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800", difficulty: "Standard" },
  { id: "g3", name: "Frog Pumps", sets: 3, reps: "20-25", he: "שכיבה על הגב, כפות רגליים צמודות וברכיים פתוחות, דחיפת אגן מהירה למעלה. פאמפ חזק לישבן.", work: 30, rest: 45, category: "isolation", muscleGroup: "Glutes", videoUrl: "https://www.youtube.com/watch?v=0h68_tN-P7w", imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800", difficulty: "Standard" },
  { id: "g4", name: "Romanian Deadlift (Glute Bias)", sets: 4, reps: "10", he: "RDL עם דגש חזק על דחיפת האגן לאחור ועבודה דרך הישבן. שמור על גב יציב.", work: 45, rest: 100, category: "legs", muscleGroup: "Glutes", videoUrl: "https://www.youtube.com/watch?v=jEy_czb3qwA", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Advanced" },

  // --- SHOULDERS (15) ---
  { id: "s1", name: "Z-Press", sets: 4, reps: "8-10", he: "לחיצת כתפיים בישיבה על הרצפה. מנטרל את הרגליים ומאלץ את הכתפיים והבטן לעבוד ב-100% מהזמן.", work: 45, rest: 120, category: "armor", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=7uV8-vWjHoo", imageUrl: "https://images.unsplash.com/photo-1591741535018-d042766c62eb?q=80&w=800", difficulty: "Elite" },
  { id: "s2", name: "Lu Raises", sets: 3, reps: "15", he: "הרמה צידית מלאה עד מעל הראש. בונה ניידות וכתפיים רחבות בצורה יוצאת דופן ומכסה את כל טווח התנועה.", work: 35, rest: 75, category: "armor", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=S0v_5SjG8nQ", imageUrl: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=800", difficulty: "Advanced" },
  ...
  { id: "s4", name: "Arnold Press", sets: 3, reps: "10", he: "לחיצה עם סיבוב ידיים מחזית הגוף כלפי חוץ. עובד על כל ראשי הכתף בתנועה אחת חלקה ומבוקרת.", work: 45, rest: 90, category: "armor", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=6Z15_WdXmVw", imageUrl: "https://images.unsplash.com/photo-1591741535018-d042766c62eb?q=80&w=800", difficulty: "Advanced" },
  { id: "s5", name: "Cable Lateral Raise", sets: 4, reps: "15", he: "הרמה צידית בכבל מאחורי הגוף. שומר על מתח תמידי לאורך כל התנועה. בונה את רוחב הכתף הצידית.", work: 35, rest: 60, category: "isolation", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=PPrzBWZqcSw", imageUrl: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=800", difficulty: "Standard" },
  { id: "s6", name: "Military Press", sets: 4, reps: "6", he: "לחיצת מוט בעמידה. התרגיל הבסיסי והחזק ביותר לבניית מסה וכוח בכתפיים ובליבה. שמור על גוף יציב.", work: 45, rest: 150, category: "armor", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=2yjwXTZQDDI", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Advanced" },
  { id: "s7", name: "Rear Delt Row", sets: 3, reps: "15", he: "חתירה בכבלים או משקולות עם מרפקים גבוהים והחוצה. מיקוד בכתף האחורית ובטרפז האמצעי.", work: 40, rest: 60, category: "isolation", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=G_H8LAtu-7w", imageUrl: "https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?q=80&w=800", difficulty: "Standard" },
  { id: "s8", name: "Upright Row (Barbell)", sets: 3, reps: "12", he: "משיכת מוט צמוד לגוף עד גובה החזה. בונה את הראש הצידי של הכתף ואת הטרפזים העליונים.", work: 40, rest: 90, category: "armor", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=amCU-ziHITM", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800", difficulty: "Standard" },
  { id: "s9", name: "Front Raise (Plate)", sets: 3, reps: "15", he: "הרמת פלטה מלפנים עד גובה העיניים. מבודד את הכתף הקדמית. שמור על גב יציב ללא תנופה מהגוף.", work: 30, rest: 60, category: "isolation", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=XvK_E_rN9f0", imageUrl: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=800", difficulty: "Standard" },
  { id: "s10", name: "Push Press", sets: 4, reps: "5", he: "לחיצת כתפיים מתפרצת עם עזרה קלה מהרגליים. בונה כוח אבסולוטי ויכולת ייצור כוח מתפרץ מהיר.", work: 40, rest: 180, category: "power", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=iaBVSJm78ko", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Elite" },
  { id: "s11", name: "Y-Raise (Incline)", sets: 3, reps: "15", he: "הרמת ידיים לצורת Y בשכיבה על ספסל בשיפוע. מצוין לחיזוק הטרפז התחתון והכתף האחורית.", work: 35, rest: 60, category: "isolation", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=Kz60pS1wB90", imageUrl: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=800", difficulty: "Standard" },
  { id: "s12", name: "Bradford Press", sets: 3, reps: "12", he: "לחיצת מוט מלפנים ומאחורי הראש לסירוגין ללא נעילה של המרפקים. יוצר מתח תמידי ועצום בכתף.", work: 45, rest: 90, category: "armor", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=7uKq0E_H06c", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Advanced" },
  { id: "s13", name: "Bus Driver", sets: 3, reps: "45s", he: "החזקת פלטה מלפנים וסיבוב ימינה ושמאלה כמו הגה. בונה סיבולת שריר גבוהה בכתף הקדמית.", work: 45, rest: 60, category: "isolation", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=S0T0YnId58Y", imageUrl: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=800", difficulty: "Standard" },
  { id: "s14", name: "HSPU (Handstand Push-Ups)", sets: 3, reps: "Max", he: "שכיבות סמיכה בעמידת ידיים מול קיר. תרגיל משקל הגוף הקשה ביותר לכתפיים ולכוח הדחיפה.", work: 45, rest: 120, category: "armor", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=hG76CqA8t9k", imageUrl: "https://images.unsplash.com/photo-1599058917233-57c0e6244a4d?q=80&w=800", difficulty: "Elite" },
  { id: "s15", name: "Dumbbell Lateral Raise", sets: 4, reps: "15", he: "הרמת משקולות לצדדים. התרגיל הקלאסי והטוב ביותר לבניית 'כתפיים תלת מימדיות' ורוחב מרשים.", work: 30, rest: 60, category: "isolation", muscleGroup: "Shoulders", videoUrl: "https://www.youtube.com/watch?v=3VcKaXpzqRo", imageUrl: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=800", difficulty: "Standard" },
  ...
  { id: "cr2", name: "Hanging Leg Raise", sets: 4, reps: "15", he: "תלייה על מוט והרמת רגליים ישרות עד גובה המותן ומעלה. עובד חזק על הבטן התחתונה והליבה העמוקה.", work: 40, rest: 60, category: "core", muscleGroup: "Core", videoUrl: "https://www.youtube.com/watch?v=G0azmX8NshI", imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800", difficulty: "Advanced" },
  { id: "cr3", name: "Ab Wheel Rollout", sets: 3, reps: "12", he: "גלישה קדימה עם גלגל בטן. שמור על גב יציב ואל תיתן לאגן לקרוס. התרגיל הכי קשוח לקיר בטן חזק.", work: 40, rest: 90, category: "core", muscleGroup: "Core", videoUrl: "https://www.youtube.com/watch?v=rqiQtEW_q_I", imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800", difficulty: "Elite" },
  { id: "cr4", name: "Cable Crunches", sets: 4, reps: "20", he: "כפיפות בטן בכריעה מול פולי עם חבל מאחורי הראש. מאפשר העמסה כבדה לבניית 'קוביות' עבות ובולטות.", work: 35, rest: 60, category: "core", muscleGroup: "Core", videoUrl: "https://www.youtube.com/watch?v=2f3E-E23e40", imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800", difficulty: "Standard" },
  { id: "cr5", name: "Plank with Reach", sets: 3, reps: "12/side", he: "מצב פלאנק ושליחת יד אחת קדימה לסירוגין ללא תזוזה של האגן. בונה יציבות ליבה נגד כוחות סיבוב.", work: 45, rest: 45, category: "core", muscleGroup: "Core", videoUrl: "https://www.youtube.com/watch?v=vV7B52Z6m40", imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800", difficulty: "Standard" },
  { id: "f1", name: "Landmine Thruster", sets: 4, reps: "10", he: "סקוואט ודחיפה של המוט מעל הראש בתנועה אחת רציפה ומתפרצת. בונה כוח בכל הגוף ותיאום מוטורי.", work: 60, rest: 120, category: "power", muscleGroup: "FullBody", videoUrl: "https://www.youtube.com/watch?v=ZfSTpIe7mK8", imageUrl: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=800", difficulty: "Advanced" },
  { id: "f2", name: "Farmer's Walk", sets: 3, reps: "40m", he: "הליכה עם משקולות כבדות מאוד בצידי הגוף. בונה אחיזה, גב עליון ויציבות ליבה אדירה של לוחם.", work: 45, rest: 120, category: "power", muscleGroup: "FullBody", videoUrl: "https://www.youtube.com/watch?v=rtZ6v1Xp_S8", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Elite" },
  { id: "f3", name: "Medicine Ball Slam", sets: 3, reps: "15", he: "הטחת כדור כוח ברצפה בכל הכוח תוך שימוש בבטן ובכתפיים. תרגיל מעולה לשריפת קלוריות וכוח מתפרץ.", work: 30, rest: 60, category: "power", muscleGroup: "FullBody", videoUrl: "https://www.youtube.com/watch?v=713X73uX46M", imageUrl: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=800", difficulty: "Standard" },
  { id: "f4", name: "Turkish Get-Up", sets: 3, reps: "5/side", he: "מעבר משכיבה על הגב לעמידה מלאה כשיד אחת מחזיקה משקולת מעל הראש. שיא היציבות והקואורדינציה.", work: 90, rest: 90, category: "power", muscleGroup: "FullBody", videoUrl: "https://www.youtube.com/watch?v=0h68_tN-P7w", imageUrl: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800", difficulty: "Elite" },
  { id: "f5", name: "Kettlebell Swing", sets: 4, reps: "20", he: "הנפת קטלבל בעזרת כוח מתפרץ מהיר של הירכיים והישבן. בונה כוח בשרשרת האחורית וסיבולת לב-ריאה.", work: 45, rest: 60, category: "power", muscleGroup: "FullBody", videoUrl: "https://www.youtube.com/watch?v=sSbyay36zS8", imageUrl: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=800", difficulty: "Standard" }
];
// --- APP HELPERS ---
...
function ReacherApp() {
  ...
  return (
    <>
      ...
      <header className="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-8 flex justify-between items-start">
        <div className="space-y-3">
          <div className="flex items-center gap-4">
            <h1 className="text-6xl md:text-7xl font-black italic uppercase tracking-tighter leading-none">Betesh<span className="text-teal-500">Training</span></h1>
          ...
          <div className="text-slate-400 font-bold text-sm">Training, nutrition, recovery, progression.</div>
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pb-40">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
            <div className="grid md:grid-cols-4 gap-6">
              <ApexCard className="p-8">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Exercises loaded</div>
                <div className="text-4xl font-black italic">{sessionList.length}</div>
              </ApexCard>
              <ApexCard className="p-8">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Session volume</div>
                <div className="text-4xl font-black italic text-teal-400">{sessionVolume}</div>
              </ApexCard>
              <ApexCard className="p-8">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Estimated kcal</div>
                <div className="text-4xl font-black italic text-amber-400">{estimateCalories(sessionVolume)}</div>
              </ApexCard>
              <ApexCard className="p-8">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Recovery score</div>
        ...
        {tab === "stats" && (
          <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              <ApexCard className="p-8">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">AI readiness</div>
              ...
              <ApexCard className="p-8">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Momentum</div>
              ...
              <ApexCard className="p-8">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Recovery mode</div>
              ...
              <ApexCard className="p-8">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Top focus</div>
