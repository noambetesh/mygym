        ...
        <div className="max-w-7xl mx-auto space-y-10">
          <header className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <ApexButton variant="outline" className="gap-2" onClick={openMusicHub}><Music size={18} /> Music</ApexButton>
    ...
    <>
      ...
      <header className="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-8 flex justify-between items-start">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <ApexButton variant="outline" size="icon" className="rounded-2xl border-white/5" onClick={openMusicHub}><Music size={22} /></ApexButton>
        </div>
      </header>
