          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              ...
              <ApexCard className="p-5 md:p-8 min-h-[140px] md:min-h-0">
                ...
                <div className="text-3xl md:text-4xl font-black italic text-teal-400">{sessionVolume}</div>
              </ApexCard>
              <ApexCard className="p-5 md:p-8 min-h-[140px] md:min-h-0">
                ...
                <div className="text-3xl md:text-4xl font-black italic text-amber-400">{estimateCalories(sessionVolume)}</div>
              </ApexCard>
              <ApexCard className="p-5 md:p-8 min-h-[140px] md:min-h-0">
                ...
                <div className="text-3xl md:text-4xl font-black italic text-indigo-400">{recoveryScore}</div>
              </ApexCard>
            </div>
